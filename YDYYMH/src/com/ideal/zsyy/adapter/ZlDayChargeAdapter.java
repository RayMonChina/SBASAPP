...
import com.ideal.zsyy.adapter.ZhuyChargeAdapter.ViewHolder;
...
public class ZlDayChargeAdapter extends BaseAdapter {

	private Context context;
	private List<HospitalChargeInfo> chargeInfos;
	private LayoutInflater inflater;

	public ZlDayChargeAdapter(Context context, List<HospitalChargeInfo> ptEntities) {
		this.context = context;
		this.chargeInfos = ptEntities;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			TextView tv_fee_time=(TextView)layout.findViewById(R.id.tv_item_fee_time);
			...
			viewHolder.setTv_feeTime(tv_fee_time);
			convertView = layout;
