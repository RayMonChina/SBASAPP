...
public class DataUtils {
	...
	public static List<SkinInfo> getSkinInfos() {
		List<SkinInfo> skinInfos = new ArrayList<SkinInfo>();
		skinInfos
				.add(new SkinInfo("0", R.drawable.skin1, "1", R.drawable.sy_bj));
		skinInfos.add(new SkinInfo("1", R.drawable.skin2, "0",
				R.drawable.sy_bj1));
		skinInfos.add(new SkinInfo("2", R.drawable.skin3, "0",
				R.drawable.sy_bj3));
		return skinInfos;
	}
	...
	public static File getFileFromServer(String urlpath, File files,
		...
		if (Environment.getExternalStorageState().equals(
			...
			String downloadpath = "http://" + Config.post + File.separator
					+ "PalmHospital" + File.separator + urlpath;
